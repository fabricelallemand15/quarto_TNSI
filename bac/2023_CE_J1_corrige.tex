...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, titlerule=0mm, coltitle=black, leftrule=.75mm, colback=white, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, toptitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, toprule=.15mm, arc=.35mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6]
