...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, coltitle=black, rightrule=.15mm, arc=.35mm, titlerule=0mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0]
