...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacityback=0, toptitle=1mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, breakable, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, bottomtitle=1mm, arc=.35mm, colback=white, rightrule=.15mm, left=2mm]
