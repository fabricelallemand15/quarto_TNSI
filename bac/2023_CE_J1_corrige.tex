...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, breakable, colback=white, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, toptitle=1mm, titlerule=0mm, opacitybacktitle=0.6, rightrule=.15mm, arc=.35mm, toprule=.15mm]
