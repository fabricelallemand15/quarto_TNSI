...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, leftrule=.75mm, colbacktitle=quarto-callout-caution-color!10!white, colback=white, arc=.35mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, breakable, left=2mm, bottomtitle=1mm, bottomrule=.15mm, coltitle=black, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{À retenir}, breakable, left=2mm, bottomtitle=1mm, bottomrule=.15mm, coltitle=black, rightrule=.15mm, opacityback=0]
