...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, enhanced, frame hidden, interior hidden, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt]}{\end{tcolorbox}}\fi

\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attention !}, coltitle=black, opacityback=0, arc=.35mm, titlerule=0mm, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colframe=quarto-callout-caution-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, coltitle=black, opacityback=0, arc=.35mm, titlerule=0mm, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomrule=.15mm]
