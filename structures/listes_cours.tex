...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, breakable, titlerule=0mm, toprule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attention !}, opacityback=0, arc=.35mm, rightrule=.15mm, colback=white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-caution-color!10!white, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-caution-color-frame, breakable, titlerule=0mm, toprule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, opacityback=0, arc=.35mm, rightrule=.15mm, colback=white, bottomrule=.15mm]
