...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-warning-color-frame, breakable, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attention !}, leftrule=.75mm, arc=.35mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-caution-color-frame, breakable, colbacktitle=quarto-callout-caution-color!10!white, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, leftrule=.75mm, arc=.35mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, left=2mm]
