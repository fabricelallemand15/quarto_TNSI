...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, toprule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, breakable, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, toprule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{La file est utile dans différents types de problèmes}, breakable, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, opacityback=0, toprule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, breakable, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, toprule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remarque (extrait de la documentation Python)}, breakable, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm]
