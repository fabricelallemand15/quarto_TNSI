...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{La pile est utile dans différents types de problèmes}, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, left=2mm, toprule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, titlerule=0mm, arc=.35mm, colframe=quarto-callout-caution-color-frame, opacitybacktitle=0.6, left=2mm, toprule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Comparaison des deux implémentations}, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, titlerule=0mm, arc=.35mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, left=2mm, toprule=.15mm, colback=white]
