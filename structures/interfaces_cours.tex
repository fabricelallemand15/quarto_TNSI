...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, breakable, bottomrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, opacityback=0, toptitle=1mm, arc=.35mm, rightrule=.15mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, breakable, bottomrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition (d'après Wikipedia)}, opacityback=0, toptitle=1mm, arc=.35mm, rightrule=.15mm, toprule=.15mm]
