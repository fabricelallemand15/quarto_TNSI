...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced, boxrule=0pt, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, coltitle=black, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, colbacktitle=quarto-callout-tip-color!10!white, colback=white, titlerule=0mm, opacityback=0, toptitle=1mm, breakable, toprule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, coltitle=black, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition (d'après Wikipedia)}, colbacktitle=quarto-callout-tip-color!10!white, colback=white, titlerule=0mm, opacityback=0, toptitle=1mm, breakable, toprule=.15mm, left=2mm, leftrule=.75mm]
