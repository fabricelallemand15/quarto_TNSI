...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, breakable, opacitybacktitle=0.6, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, bottomtitle=1mm, coltitle=black, toptitle=1mm, rightrule=.15mm, colback=white, left=2mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, breakable, opacitybacktitle=0.6, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition (d'après Wikipedia)}, bottomtitle=1mm, coltitle=black, toptitle=1mm, rightrule=.15mm, colback=white, left=2mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm]
