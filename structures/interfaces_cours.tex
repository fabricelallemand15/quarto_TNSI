...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacityback=0, breakable, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, leftrule=.75mm, left=2mm, rightrule=.15mm, arc=.35mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacityback=0, breakable, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition (d'après Wikipedia)}, leftrule=.75mm, left=2mm, rightrule=.15mm, arc=.35mm, titlerule=0mm]
