...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, left=2mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, colback=white, bottomrule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition (d'après Wikipedia)}, left=2mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colframe=quarto-callout-tip-color-frame, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, colback=white, bottomrule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, arc=.35mm]
