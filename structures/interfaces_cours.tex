...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, titlerule=0mm, rightrule=.15mm, left=2mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, titlerule=0mm, rightrule=.15mm, left=2mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition (d'après Wikipedia)}, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm]
