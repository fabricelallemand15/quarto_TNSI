...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, opacityback=0, leftrule=.75mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, left=2mm, bottomrule=.15mm, titlerule=0mm, breakable, colback=white]
