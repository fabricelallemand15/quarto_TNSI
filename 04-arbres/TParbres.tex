...
\hypersetup{
  pdftitle={TP - Manipulation d'arbres},
  pdflang={fr},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\hypertarget{t.p.-arbres-binaires-quelques-compluxe9ments-utiles}{%
\subsection{T.P. : Arbres binaires, quelques compléments
utiles}\label{t.p.-arbres-binaires-quelques-compluxe9ments-utiles}}

Ce T.P. est à réaliser et à rendre dans
\href{https://capytale2.ac-paris.fr}{Capytale}.
