---
title: "9.1 Systèmes sur puce (cours)"
---
...
**Capacité : jusqu'à 24 To (HDD)**

**Vitesse : jusqu'à 7 Go/s (SSD NVMe PCIe 4.0)**
...
Les meilleurs SoC, plus fins que les microprocesseurs « classiques » de dernière génération, sont gravés en 3 nm (voire 2 nm en développement) et comprennent des milliards de transistors. Un tel système sur puce est conçu et mis au point de façon logicielle, ses briques électroniques sont accessibles par des APIs, comme pour les bibliothèques logicielles.
...
* Apple iPhone 16 : SoC A18 Pro

* Samsung Galaxy S25 : SoC Snapdragon 8 Elite

* Nintendo Switch 2 : SoC Nvidia T239

* Apple MacBook Air/Pro (ordinateur portable) : SoC M4

Le marché des SoC a aujourd'hui un poids économique très important. De nombreux ordinateurs portables sont désormais équipés de SoC à la place des cartes mères "classiques". Les SoC ont rattrapé, et parfois dépassé, les systèmes "classiques" en termes de puissance : les MacBook d'Apple équipés de SoC M4 rivalisent avec des PC de bureau haut de gamme, et des PC portables sous Windows utilisent aussi des SoC (Snapdragon X Elite de Qualcomm).
...
Dans sa version 5 (2023), le Raspberry Pi est équipé du SoC BCM2712 de la société Broadcom

### 2.4 Architecture simplifiée d'un SoC (exemple : Samsung Exynos 990)
