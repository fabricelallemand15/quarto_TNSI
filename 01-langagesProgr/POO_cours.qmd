...
Des [compléments sur la POO](POO_complements.qmd) sont proposés à la suite de ce cours.
...
C'est l'informaticien Alan Kay (1940-) qui est considéré comme l'un des pères de la programmation orientée objets.
...
En utilisant Python, nous avons déjà fréquenté des classes d'objets : il est usuel de lire qu'en Python "tout est objet".
