...
[Voir le corrigé](https://sitelf.fr/notebook/?from=https://sitelf.fr/nsi/assets/notebooks/exo3_POO_CORR.ipynb){target=_blank .md-button .md-button--primary}
...
[Voir le corrigé](https://sitelf.fr/notebook/?from=https://sitelf.fr/nsi/assets/notebooks/exo4_POO_CORR.ipynb){target=_blank .md-button .md-button--primary}
