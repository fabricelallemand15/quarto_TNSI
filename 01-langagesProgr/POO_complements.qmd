...
Il convient pour cela, en toute rigueur, de définir des méthodes ad-hoc : une méthode qui permet d'accéder à un attribut est un `getter`, une méthode qui permet de changer la valeur d'un attribut est un `setter`.
