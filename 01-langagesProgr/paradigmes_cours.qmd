...
Vu le grand nombre de langages existants, une classification s'est faite jour. On regroupe en général les langages en « familles » selon le paradigme de programmation auquel ils sont (le mieux) adaptés.
...
Les différents principes de la conception orientée objet aident à la réutilisation du code, au masquage des données, etc. Les bases de la POO sont détaillées dans le [cours correspondant](POO_cours.qmd), avec ses [compléments](POO_complements.qmd).
