---
title: "9.2 - T.P. : Processus sous Linux"
---

![linux](linux-154544_640.png){width=30%}

1. Ouvrir un terminal pour travailler en ligne de commandes.
...
3. Créer un fichier `TPlinuxTNSI.odt` avec le traitement de texte LibreOffice Writer.
...
4. **Observation des processus**
    ...
    * **La commande top** donne beaucoup de détails, en temps réel, sur les processus qui tournent sur une machine :
        ...
        * **COMMAND** : nom du processus.
        ...
        Pour en savoir plus sur la commande top, consultez la page : [http://debian-facile.org/doc:systeme:top](http://debian-facile.org/doc:systeme:top){target="_blank"}.
...
5. Ouvrir le navigateur Firefox et chercher avec le moteur de recherche
    ...
    Rouvrir le navigateur, puis noter à quel processus il correspond dans
    ...
    ![zombie](zombies-1296507_640.png){width=20%}
