...
* {{< fa check >}} créer une base de données ;
* {{< fa check >}} ajouter des données dans une table ;
* {{< fa check >}} écrire et tester différentes requêtes.
:::
...
2. Pour créer une table, cliquez sur l'onglet "Exécuter le SQL". On obtient alors :
    ...
    ![](TP1_4.png){ width=50% fig-align="center"}
...
4. Saisissez et exécutez la requête SQL suivante :
    ...
    ![](TP1_7.png){ width=50% fig-align="center"}
