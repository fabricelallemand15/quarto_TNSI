...
[Version Notebook de ce cours](https://sitelf.fr/notebook/?kernel=sql&extensions=admonitions&module=https://tnsi.sitelf.fr/03-BDD/Cantal.db&from=https://tnsi.sitelf.fr/03-BDD/cours_SQL.ipynb){ target=_blank }
