---
title: Le langage SQL (Cours - Partie 3)
lang: fr
...
[Version Notebook de ce cours](https://sitelf.fr/notebook/?kernel=sql&extensions=admonitions&module=https://sitelf.fr/TNSI/03-BDD/Cantal.db&from=https://sitelf.fr/TNSI/03-BDD/cours_SQL.ipynb){ target=_blank }
...
Pour se connecter à cette base de donnée, vous pouvez utiliser le logiciel DB Browser (SqLite) ou bien le notebook SQL en lien ci-dessus.
