...
[Version Notebook de ce cours](https://sitelf.fr/notebook/?kernel=sql&extensions=admonitions&module=https://sitelf.fr/nsi/assets/BDD/Cantal.db&from=https://sitelf.fr/nsi/assets/notebooks/cours_SQL.ipynb){ target=_blank }
