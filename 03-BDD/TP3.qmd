...
Dans ce TP (source : @lassus), nous allons créer et interroger une base de données ```sqlite``` avec le module ```sqlite3```  de Python.
...
<img src="TP3_1.gif" alt="TP3_1" style="zoom:50%;" />

\includegraphics[width=0.5\textwidth]{TP3_1-0.png}
<!-- ![](TP3_1.gif){ fig-align="center"} -->
