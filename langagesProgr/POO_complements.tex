...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, sharp corners, enhanced, interior hidden, boxrule=0pt, breakable, frame hidden]}{\end{tcolorbox}}\fi

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, breakable, colback=white, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Avertissement}, bottomtitle=1mm, opacityback=0, coltitle=black, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, breakable, colback=white, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Conventions de nommage en Python}, bottomtitle=1mm, opacityback=0, coltitle=black, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, breakable, colback=white, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Héritage et initialiseur}, bottomtitle=1mm, opacityback=0, coltitle=black, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm]
