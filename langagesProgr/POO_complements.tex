...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, interior hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, frame hidden, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Avertissement}, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm, colframe=quarto-callout-warning-color-frame, arc=.35mm, breakable, colback=white, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Conventions de nommage en Python}, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm, colframe=quarto-callout-important-color-frame, arc=.35mm, breakable, colback=white, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Héritage et initialiseur}, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm, colframe=quarto-callout-warning-color-frame, arc=.35mm, breakable, colback=white, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white]
