...
\hypersetup{
  pdftitle={Paradigmes de programmation (Quiz)},
  pdflang={fr},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{Paradigmes de programmation (Quiz)}
\usepackage{etoolbox}
\makeatletter
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, breakable, frame hidden, sharp corners, interior hidden, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
