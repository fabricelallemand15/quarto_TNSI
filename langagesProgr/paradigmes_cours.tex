...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Définition}, toptitle=1mm, coltitle=black, opacityback=0, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{À retenir}, toptitle=1mm, coltitle=black, opacityback=0, titlerule=0mm, arc=.35mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, breakable, toprule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Remarque}, toptitle=1mm, coltitle=black, opacityback=0, titlerule=0mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, toprule=.15mm, colback=white]
