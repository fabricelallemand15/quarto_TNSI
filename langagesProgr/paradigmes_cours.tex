...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, leftrule=.75mm, arc=.35mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, breakable, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Définition}, opacitybacktitle=0.6, bottomrule=.15mm, bottomtitle=1mm, coltitle=black, toptitle=1mm, titlerule=0mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, leftrule=.75mm, arc=.35mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, breakable, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{À retenir}, opacitybacktitle=0.6, bottomrule=.15mm, bottomtitle=1mm, coltitle=black, toptitle=1mm, titlerule=0mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, leftrule=.75mm, arc=.35mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, breakable, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Remarque}, opacitybacktitle=0.6, bottomrule=.15mm, bottomtitle=1mm, coltitle=black, toptitle=1mm, titlerule=0mm, opacityback=0]
