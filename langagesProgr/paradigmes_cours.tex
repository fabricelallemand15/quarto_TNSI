...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Définition}, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, leftrule=.75mm, opacityback=0, colback=white, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{À retenir}, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, leftrule=.75mm, opacityback=0, colback=white, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Remarque}, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, leftrule=.75mm, opacityback=0, colback=white, coltitle=black]
