...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, left=2mm, colback=white, titlerule=0mm, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, breakable, toptitle=1mm, arc=.35mm]
