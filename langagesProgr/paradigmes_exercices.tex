...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, breakable, leftrule=.75mm, toprule=.15mm, left=2mm, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0]
