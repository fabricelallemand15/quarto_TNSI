...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, left=2mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, toprule=.15mm, breakable, opacityback=0, coltitle=black, colback=white, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, bottomrule=.15mm, titlerule=0mm]
