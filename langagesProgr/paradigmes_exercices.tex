...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, opacitybacktitle=0.6, arc=.35mm, colback=white, bottomtitle=1mm, opacityback=0, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, rightrule=.15mm, bottomrule=.15mm, left=2mm, titlerule=0mm]
