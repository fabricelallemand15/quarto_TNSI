...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, colback=white, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, left=2mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, opacityback=0]
