...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, bottomtitle=1mm, arc=.35mm, toprule=.15mm, coltitle=black, breakable, opacityback=0, left=2mm, opacitybacktitle=0.6]
