...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced, sharp corners, boxrule=0pt, frame hidden, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Complément pour les curieux}, opacitybacktitle=0.6, left=2mm, colback=white, breakable, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, coltitle=black, titlerule=0mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm]
