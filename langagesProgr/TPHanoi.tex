...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colback=white, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, rightrule=.15mm, coltitle=black, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Objectifs}, toprule=.15mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colback=white, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, breakable, rightrule=.15mm, coltitle=black, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Critères d'évaluation}, toprule=.15mm, titlerule=0mm]
