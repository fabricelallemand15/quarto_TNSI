...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toprule=.15mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Limitation propre à Python}, opacitybacktitle=0.6, coltitle=black, left=2mm, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, breakable, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toprule=.15mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Les trois règles de récursivité}, opacitybacktitle=0.6, coltitle=black, left=2mm, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, toptitle=1mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, breakable, opacityback=0]
