...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Limitation propre à Python}, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, colback=white, breakable, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Les trois règles de récursivité}, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, colback=white, breakable, opacitybacktitle=0.6]
