...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, rightrule=.15mm, toptitle=1mm, bottomrule=.15mm, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Limitation propre à Python}, opacitybacktitle=0.6, titlerule=0mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, toprule=.15mm, opacityback=0, arc=.35mm, coltitle=black, left=2mm]
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{RecursionError: maximum recursion depth exceeded }\ControlFlowTok{while}\NormalTok{ calling a Python }\BuiltInTok{object}
\end{Highlighting}
\end{Shaded}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, rightrule=.15mm, toptitle=1mm, bottomrule=.15mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Les trois règles de récursivité}, opacitybacktitle=0.6, titlerule=0mm, breakable, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, toprule=.15mm, opacityback=0, arc=.35mm, coltitle=black, left=2mm]
