...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-warning-color-frame, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Limitation propre à Python}, bottomtitle=1mm, leftrule=.75mm, opacityback=0, breakable, bottomrule=.15mm, colback=white, left=2mm, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-important-color-frame, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Les trois règles de récursivité}, bottomtitle=1mm, leftrule=.75mm, opacityback=0, breakable, bottomrule=.15mm, colback=white, left=2mm, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white]
