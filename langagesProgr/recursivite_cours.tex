...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, rightrule=.15mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, breakable, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Limitation propre à Python}, arc=.35mm, opacityback=0, left=2mm, colframe=quarto-callout-warning-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, rightrule=.15mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, breakable, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Les trois règles de récursivité}, arc=.35mm, opacityback=0, left=2mm, colframe=quarto-callout-important-color-frame]
