...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, toptitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Contraintes liées aux clefs}, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, coltitle=black, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, breakable, colback=white]
