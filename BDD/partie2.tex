...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, sharp corners, enhanced, borderline west={3pt}{0pt}{shadecolor}, frame hidden, interior hidden]}{\end{tcolorbox}}\fi

\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, colback=white, colframe=quarto-callout-tip-color-frame, opacityback=0, opacitybacktitle=0.6, coltitle=black, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, colback=white, colframe=quarto-callout-important-color-frame, opacityback=0, opacitybacktitle=0.6, coltitle=black, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Règles à respecter}, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, titlerule=0mm, left=2mm, breakable, bottomtitle=1mm, toptitle=1mm, colback=white, colframe=quarto-callout-important-color-frame, opacityback=0, opacitybacktitle=0.6, coltitle=black, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Contraintes liées aux clefs}, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm]
