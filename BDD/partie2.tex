...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, titlerule=0mm, arc=.35mm, breakable, toptitle=1mm, toprule=.15mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, titlerule=0mm, arc=.35mm, breakable, toptitle=1mm, toprule=.15mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Règles à respecter}, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, titlerule=0mm, arc=.35mm, breakable, toptitle=1mm, toprule=.15mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Contraintes liées aux clefs}, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, opacityback=0]
