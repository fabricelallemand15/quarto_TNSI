...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame, arc=.35mm, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Contraintes liées aux clefs}, titlerule=0mm, breakable, colback=white, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, toptitle=1mm, coltitle=black, leftrule=.75mm]
