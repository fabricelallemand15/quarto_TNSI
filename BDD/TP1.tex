...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, boxrule=0pt, enhanced, frame hidden, interior hidden, borderline west={3pt}{0pt}{shadecolor}, breakable]}{\end{tcolorbox}}\fi

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Objectifs}, bottomrule=.15mm, colback=white, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-tip-color-frame, titlerule=0mm, arc=.35mm, rightrule=.15mm]
