...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, leftrule=.75mm, breakable, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, coltitle=black, bottomtitle=1mm, arc=.35mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Objectifs}, toptitle=1mm, titlerule=0mm, rightrule=.15mm]
