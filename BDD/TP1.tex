...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Objectifs}, arc=.35mm, bottomrule=.15mm, breakable, colback=white, opacitybacktitle=0.6, titlerule=0mm, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm]
