...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacityback=0, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Objectifs}, toprule=.15mm, arc=.35mm, titlerule=0mm, breakable, bottomrule=.15mm, leftrule=.75mm, colback=white]
