...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, breakable, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, titlerule=0mm, opacityback=0, colback=white, left=2mm, toptitle=1mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, bottomtitle=1mm, breakable, leftrule=.75mm]
...
\href{\%5B../../../premiere/07_tables/tables_cours.md\%5D(https://flallemand.fr/nsi/premiere/07_tables/tables_cours/)}{travaillé
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Définitions}, titlerule=0mm, opacityback=0, colback=white, left=2mm, toptitle=1mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, bottomrule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, bottomtitle=1mm, breakable, leftrule=.75mm]
