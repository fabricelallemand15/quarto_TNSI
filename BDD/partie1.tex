...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Définitions}, toptitle=1mm, left=2mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm, breakable, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Définition}, toptitle=1mm, left=2mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm, breakable, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
