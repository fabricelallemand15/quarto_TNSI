...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, colback=white, left=2mm, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, toptitle=1mm, titlerule=0mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Précisions au sujet du support papier}, opacitybacktitle=0.6, rightrule=.15mm, opacityback=0, toprule=.15mm]
