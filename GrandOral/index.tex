...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, toprule=.15mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Précisions au sujet du support papier}, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, breakable, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, colback=white, colframe=quarto-callout-important-color-frame]
