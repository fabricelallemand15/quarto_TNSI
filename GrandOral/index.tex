...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, opacitybacktitle=0.6, toprule=.15mm, breakable, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Précisions au sujet du support papier}, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, leftrule=.75mm, colback=white, left=2mm, toptitle=1mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, titlerule=0mm, rightrule=.15mm]
