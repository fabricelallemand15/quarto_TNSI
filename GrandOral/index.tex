...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, toptitle=1mm, arc=.35mm, colback=white, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Précisions au sujet du support papier}, rightrule=.15mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, toprule=.15mm, leftrule=.75mm, opacityback=0]
