...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, arc=.35mm, rightrule=.15mm, breakable, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Complément}, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, left=2mm]
