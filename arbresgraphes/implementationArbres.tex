...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, opacityback=0, coltitle=black, arc=.35mm, bottomrule=.15mm, colback=white, leftrule=.75mm, left=2mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Complément}, bottomtitle=1mm, rightrule=.15mm]
