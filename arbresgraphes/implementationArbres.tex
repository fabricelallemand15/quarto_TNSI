...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, coltitle=black, colback=white, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Complément}, toprule=.15mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm]
