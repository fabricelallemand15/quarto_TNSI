...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, colframe=quarto-callout-caution-color-frame, rightrule=.15mm, colback=white, bottomtitle=1mm, left=2mm, toptitle=1mm, opacityback=0, toprule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{TP Python}, leftrule=.75mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, colback=white, bottomtitle=1mm, left=2mm, toptitle=1mm, opacityback=0, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition : liste d'adjacence}, leftrule=.75mm, arc=.35mm]
