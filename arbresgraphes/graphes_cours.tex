...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition}, left=2mm, coltitle=black, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{TP Python}, left=2mm, coltitle=black, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Définition : liste d'adjacence}, left=2mm, coltitle=black, leftrule=.75mm, toprule=.15mm]
