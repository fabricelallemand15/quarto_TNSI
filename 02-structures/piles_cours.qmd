...
Conformément au programme, on se limite à une version **naïve** de la POO. On pourra à titre d'exercice reprendre cette implémentation en respectant les règles plus strictes édictées dans [les compléments de cours sur la POO](../01-langagesProgr/POO_complements.qmd).
...
On utilise pour cela la bibliothèque ``timeit`` présentée dans [cet article](https://www.sitelf.fr/wp/2022/06/05/mesurer-le-temps-dexecution-dun-fragment-de-code/){ target=_blank }.
