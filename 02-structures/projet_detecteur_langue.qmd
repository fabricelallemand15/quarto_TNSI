...
![Tour de Babel](Pieter_Bruegel_the_Elder_-_The_Tower_of_Babel_(Vienna)_-_Google_Art_Project_-_edited.jpg){width="50%"}
...
* voici un fichier texte pour tester votre programme : [texte](texteFR.txt){target="_blank"}.
...
Pour tester votre programme, voici des fichiers texte dans les différentes langues concernées : [textes](textes.zip){target="_blank"} (fichier .zip à décompresser).
