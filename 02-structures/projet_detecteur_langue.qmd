...
* voici un fichier texte pour tester votre programme : [texte](texteFR.txt).
...
Pour tester votre programme, voici des fichiers texte dans les différentes langues concernées : [textes](textes.zip) (fichier .zip à décompresser).
