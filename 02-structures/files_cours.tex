...
\begin{tcolorbox}[enhanced jigsaw, colback=white, breakable, rightrule=.15mm, opacityback=0, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{La file est utile dans différents types de problèmes}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, coltitle=black, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, breakable, rightrule=.15mm, opacityback=0, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, arc=.35mm, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exemple}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, coltitle=black, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, breakable, rightrule=.15mm, opacityback=0, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remarque (extrait de la documentation Python)}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, coltitle=black, toprule=.15mm, leftrule=.75mm]
